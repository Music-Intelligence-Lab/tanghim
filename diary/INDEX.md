...
- [2026-02-23](2026-02-23.md) — Sessions 33–34: MIDI clip export encoding fix (ASCII transliteration for Mac Roman DAW compatibility), new clip name format `maqamname_(PAOname-IPN-solfege).mid`, drag-to-filesystem fix. Chronological tuning system dropdown sorting by year + displayName tiebreaker. Removed mouse/trackpad horizontal scrolling from slider bank, RangeScroller magnetic snap to C/G/A tick marks.
