...
- [2026-02-20](2026-02-20.md) — Session 17: M4L Receiver working (MPE + Mono PB). Fixed VST3 parameter index offset (JUCE bypass param at index 0), added Ableton `is_mpe` flag for multi-channel MIDI output, fixed pitch bend snap-back on Note Off. Includes comprehensive guide for building microtuning M4L devices.
