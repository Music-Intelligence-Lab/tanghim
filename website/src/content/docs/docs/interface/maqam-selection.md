---
title: Maqam Selection
description: How to select a maqam and its transposition.
---
...
If a matching unmodified preset exists in the [Preset Bar](/docs/interface/presets), it is automatically activated.
